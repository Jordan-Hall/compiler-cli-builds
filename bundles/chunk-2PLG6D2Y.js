...
var PipeDecoratorHandler = class {
  ...
  analyze(clazz, decorator) {
    ...
    if (!pipe.has("name")) {
      ...
      pipe.set("name", ts49.factory.createStringLiteral(classNameWithoutSuffix.charAt(0).toLowerCase() + classNameWithoutSuffix.slice(1), true));
    }
 ...
 */
//# sourceMappingURL=chunk-2PLG6D2Y.js.map
